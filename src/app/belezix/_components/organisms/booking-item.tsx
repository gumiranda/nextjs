...
import { Badge } from "@/shared/ui/atoms/shadcn/badge";
...
import PhoneItem from "../molecules/phone-item";
      ...
      <SheetContent className="w-[85%]">
        ...
        <div className="mt-6">
          ...
          <div className="space-y-3">
            {barbershop.phones.map((phone: any, index: any) => (
              <PhoneItem key={index} phone={phone?.number} />
            ))}
          </div>
        </div>
